...
export default function StatsCards({ statsUsers }) {
    const {t}=useTranslation()
    const total = statsUsers.totalUsers
    const active = statsUsers.activeUsers
    const inactive =  statsUsers.inActiveUsers
    return (
        <>
             {/* Stats Cards */}
